            ...
            <div className="w-full lg:w-2/3">
              <div className="w-full aspect-video bg-black rounded-xl overflow-hidden">
                <iframe
                  width="840"
                  height="480"
                  src="https://www.youtube.com/embed/cWppAbqm9I8?si=X7C0TBJJhHZZ1vWO"
              ...
              <div className="bg-gray-100 p-4 rounded-xl mt-4 text-left">
                ...
                <p className="mt-3">
                  ...
                  Astley. The new album 'Are We There Yet?' is out now: download
                  here: https://rickastley.lnk.to/AreWeThereYet
                </p>
              </div>
              {/* Comments Section */}
              <div className="mt-8">
                  ...
                  {[1, 2, 3].map((comment) => (
                    <div key={comment} className="flex items-start gap-3">
                      ...
                      <div className="text-left">
                        ...
                        <div className="mt-1">
                          This song never gets old! Classic 80s vibe that always
